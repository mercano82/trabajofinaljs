...
function calculaCuota(){
    ...
    const sueldo = forma['sueldo'];
    var inputSueldo= document.getElementById("sueldo");
    localStorage.setItem("sueldo", inputSueldo.value);
    ...
    const condicionSueldo = (sueldo.value != null && sueldo.value != 0 && sueldo.value != "");
    ...
    if (condicionSueldo == null || condicionSueldo == 0 || condicionSueldo == "" || condicionEdad == null || condicionEdad == 0 || condicionEdad == "" || condicionMonto == null || condicionMonto == 0 || condicionMonto == "" || condicionPlazo == null || condicionPlazo == 0 || condicionPlazo == "" || condicionNombre == null || condicionNombre == "") {
        swal("Por favor, ingresá todos los datos solicitados");
        return
                
    } else if (sueldo.value >= 50000 && edad.value >= 18 && edad.value <28) {
        tasaInteres = 50;
    
    } else if (sueldo.value >= 90000 && edad.value >= 28 && edad.value <55) {
        tasaInteres = 55;
    
    } else if (sueldo.value >= 90000 && edad.value >= 55 && edad.value <70) {
        tasaInteres = 65;
    
    } else if (sueldo.value >= 90000 && edad.value >= 70) {
        tasaInteres = 70;
    
    } else {
        swal("Lo sentimos, no calificas para un préstamo");
        tasaInteres = 0;                
    }
    ...
    $("#cuota").html(`<section id="p1"><h2><strong> El valor de la cuota es de: ${cuota} <strong></h2>
        <ul><li class="listaDos"> La tasa de interés otorgada es de un: ${tasaInteres}% </li>
...
function calcularCuota(monto, tasaInteres, plazo) {
    ...
    if (sueldo.value >= 50000 && edad.value >= 18 && edad.value <28) {
        tasaInteres = 50;
